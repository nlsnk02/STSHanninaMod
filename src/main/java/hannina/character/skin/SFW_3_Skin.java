...
public class SFW_3_Skin extends AbstractSkin{
    public static final String ID="SFW-3";
    public SFW_3_Skin() {
        super(ID);
    }
    ...
    public void loadDefault() {
        atlasPath= ModHelper.getImgPath("char/skin/SFW-3/Hannina_SFW-3/Hannina_SFW-3.atlas");
        skeletonPath= ModHelper.getImgPath("char/skin/SFW-3/Hannina_SFW-3/hannina_sfw-337.json");
    }
